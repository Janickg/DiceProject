...
public class Craps {
    ...
    public static void playCrabs(int[] rolls){
        ...
        if (rollsSum == 7 || rollsSum == 11){ //Win condition på første slag
            System.out.println("Du slog: " + rolls[0] + " og " + rolls[1] + " = " + rollsSum + ", du vandt!");
        }else if (rollsSum == 2 || rollsSum == 3 || rollsSum == 12){ //lose condtion på første slag
            System.out.println("Du slog: " + rolls[0] + " og " + rolls[1] + " = " + rollsSum + ", du tabte!");
        }else{
            point = rollsSum;
            System.out.println("Du slog " + rolls[0] + " og " + rolls[1] + ", du skal nu ramme " + rollsSum + " point.");
            if (!continuegame(point));} //metode for at fortsætte spillet hvis hverken win eller lose condition opfyldes retunere false hvis spillet skal stoppes
